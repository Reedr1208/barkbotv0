...
const styles = StyleSheet.create({
  ...
  metaText: { fontFamily: font.bold, fontSize: 12.5, color: colors.textMuted, flexShrink: 1 },
  ...
  traitWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 6 },
  ...
  ctaPrimary: { backgroundColor: colors.accent, borderColor: colors.accent },
  ctaTitle: { fontFamily: font.black, fontSize: 13.5, color: colors.textMain, marginTop: 4 },
  ctaTitlePrimary: { color: colors.accentText },
  ctaSub: { fontFamily: font.semibold, fontSize: 11.5, color: colors.textFaint },
  ctaSubPrimary: { color: 'rgba(17,24,39,0.7)' },
  ...
  freshnessTitle: { fontFamily: font.bold, fontSize: 12.5, color: colors.textMuted, flexShrink: 1 },
  freshnessSub: { fontFamily: font.regular, fontSize: 12, color: colors.textFaint, marginTop: 4 },
