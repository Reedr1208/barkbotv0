    ...
    gtag('config', 'G-4GRL2M87SZ');
      ...
      async function fetchRandomDog(forcedAnimalId = null, loadOptions = {}) {
        ...
        try {
          ...
          const shortLoc = dog.located_at ? (dog.located_at.includes('Muddy') ? 'MP' : (dog.located_at.includes('Humane') || dog.located_at.includes('HSSA') ? 'HSSA' : (dog.located_at.includes('Animal Care Centers') || dog.located_at.includes('NYC') ? 'NYCACC' : 'PACC'))) : 'PACC';
          ...
          <div style="display:flex; gap:14px; align-items:flex-start;">
            ...
            <div style="flex:1; min-width:0; display:flex; flex-direction:column; gap:2px;">
              ...
              <div style="display:flex; flex-wrap:wrap; gap:4px; margin-top:4px;">
                ...
                <span style="font-size:0.68rem; background:rgba(255,255,255,0.05); color:var(--text-muted); padding:2px 6px; border-radius:6px; font-weight:700;">${d.located_at ? (d.located_at.includes('Muddy') ? 'MP' : (d.located_at.includes('Humane') || d.located_at.includes('HSSA') ? 'HSSA' : (d.located_at.includes('Animal Care Centers') || d.located_at.includes('NYC') ? 'NYCACC' : d.located_at.replace('Pima Animal Care Center', 'PACC')))) : 'PACC'}</span>
              </div>
            </div>
