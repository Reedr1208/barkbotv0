...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        script_path = Path(__file__).resolve().parent.parent / "jobs" / "04_scrape_hssa_inventory.py"
        
        try:
            # Setting max timeout slightly higher than the python script's 200s internal stop
